...
function func(){
//alert("inside");
//$.get("setting_checkpassword.asp", function(data){
...
{
document.getElementById("key_tag").innerHTML = "<font color=\"#FF0000\"<b>Invalid characters for WEP.</b></font>";
return false;
}
/*
if(!checkWEP(F.key))
...
<div id="main">
	<div class="row">
		<div class="twelve columns">
			<div id="intro1">
			<!--<h1>Enter a password to join <script language="javascript">if (getQuerystring('network') == "") { document.write("{{REPLACE WITH NETWORK NAME}}");} else {document.write(getQuerystring('network'));}</script></h1>-->
	...
	<div id="actions">
		<div class="row">
			<div class="twelve columns">
				...
				<a id="Back" class="inline-block right-on-desktops" style="margin: 11px 85px 0 0;" href="javascript:foo();" ><script type="text/javascript">dw(btn4)</script></a>
			</div>
		</div>
	</div>
</div>
